...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(Constants.ServiceResponseConstants.STATUS_CODE, zza(this.zzh)).add("resolution", this.zzi).add(GroupInvitationContract.Invitation.MESSAGE, this.zzj).toString();
    }
