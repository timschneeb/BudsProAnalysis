...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public void startSettlingAnimation(View view, int i, int i2, boolean z) {
        ...
        ViewDragHelper viewDragHelper2 = this.viewDragHelper;
        if (viewDragHelper2 != null) {
            z2 = z ? viewDragHelper2.settleCapturedViewAt(view.getLeft(), i2) : viewDragHelper2.smoothSlideViewTo(view, view.getLeft(), i2);
        } else {
            z2 = false;
        }
        if (z2) {
    ...
    private void updateImportantForAccessibility(boolean z) {
        ...
        if (weakReference != null) {
            ViewParent parent = (weakReference == null || weakReference.get() == null) ? null : this.viewRef.get().getParent();
