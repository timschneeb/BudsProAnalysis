...
public class BottomNavigationView extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSelectedCallback = new MenuBuilder.Callback() {
        ...
        this.presenter = new BottomNavigationPresenter(context2);
        ...
        setItemIconSize(obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.BottomNavigationView_itemIconSize, getResources().getDimensionPixelSize(R.dimen.sesl_bottom_navigation_icon_size)));
        ...
        seslSetHasIcon(obtainTintedStyledAttributes.getBoolean(R.styleable.BottomNavigationView_seslBottomBarHasIcon, true));
        ...
        this.menu.setCallback(this.mSelectedCallback);
        this.menuView.setOverflowSelectedCallback(this.mSelectedCallback);
    }
    ...
    public boolean seslIsOverflowShowing() {
        ...
        return bottomNavigationPresenter != null && bottomNavigationPresenter.isOverflowMenuShowing();
    }

    public void seslHideOverflowMenu() {
        BottomNavigationPresenter bottomNavigationPresenter = this.presenter;
        if (bottomNavigationPresenter != null) {
            bottomNavigationPresenter.hideOverflowMenu();
        }
    }
    ...
    public void seslSetHasIcon(boolean z) {
        this.menuView.setHasIcon(z);
    }

    public void seslSetUpdateAnimation(boolean z) {
        BottomNavigationPresenter bottomNavigationPresenter = this.presenter;
        if (bottomNavigationPresenter != null) {
            bottomNavigationPresenter.setAnimationEnable(z);
        }
    }
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        view.setBackgroundColor(ContextCompat.getColor(context, R.color.sesl_bottom_navigation_shadow_color));
