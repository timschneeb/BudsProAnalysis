...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public ActionMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mActionButtonPaddingStart = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mActionButtonPaddingEnd = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        ...
        this.mOverflowButtonPaddingStart = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mOverflowButtonPaddingEnd = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, R.styleable.View, R.attr.actionButtonStyle, 0);
        this.mActionButtonPaddingStart = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mActionButtonPaddingEnd = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = getContext().obtainStyledAttributes(null, R.styleable.View, R.attr.actionOverflowButtonStyle, 0);
        this.mOverflowButtonPaddingStart = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mOverflowButtonPaddingEnd = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        this.mOverflowButtonMinWidth = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_android_minWidth, 0);
        obtainStyledAttributes2.recycle();
                ...
                if (childAt instanceof ActionMenuItemView) {
                    ...
                    if (i3 == i4) {
                        ...
                        if (!actionMenuItemView.hasText()) {
                            ...
                            layoutParams.rightMargin = this.mActionButtonPaddingEnd;
                            childAt.setLayoutParams(layoutParams);
                        } else {
                            layoutParams.leftMargin = this.mActionButtonPaddingEnd;
                            childAt.setLayoutParams(layoutParams);
                        }
                    } else if (i3 < i4) {
