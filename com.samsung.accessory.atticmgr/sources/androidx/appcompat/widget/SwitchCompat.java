...
public class SwitchCompat extends CompoundButton {
    ...
    public void setTrackDrawable(Drawable drawable) {
        ...
        if (drawable != null) {
            this.mTrackOnDrawable = drawable.getConstantState().newDrawable();
            this.mTrackOffDrawable = drawable.getConstantState().newDrawable();
            this.mTrackOnDrawable.setState(new int[]{16842910, 16842912});
            this.mTrackOffDrawable.setState(new int[]{16842910, -16842912});
            drawable.setCallback(this);
        }
    ...
    private void animateThumbToCheckedState(final boolean z) {
        ...
        this.mPositionAnimator.setInterpolator(SeslAnimationUtils.ELASTIC_50);
        this.mPositionAnimator.setAnimationListener(new Animation.AnimationListener() {
            /* class androidx.appcompat.widget.SwitchCompat.AnonymousClass2 */
