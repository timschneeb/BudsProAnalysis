    ...
    public void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (!(drawable == null || background == null)) {
                ...
                DrawableCompat.setHotspotBounds(background, paddingLeft, 0, paddingLeft + i5, max);
            }
            i4 = max;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i8 = Math.max(i8, measureChildCollapseMargins(this.mSubtitleTextView, i, i12 + i15, i2, i7 + i14, iArr));
