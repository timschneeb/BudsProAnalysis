    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            if (this.mOverlayActionMode) {
                viewGroup = (ViewGroup) from.inflate(R.layout.sesl_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                viewGroup = (ViewGroup) from.inflate(R.layout.sesl_screen_simple, (ViewGroup) null);
            }
    ...
    public void closePanel(PanelFeatureState panelFeatureState, boolean z) {
        ...
        if (!z || panelFeatureState.featureId != 0 || (decorContentParent = this.mDecorContentParent) == null || !decorContentParent.isOverflowMenuShowing()) {
            ...
            if (!(windowManager == null || !panelFeatureState.isOpen || panelFeatureState.decorView == null)) {
                if (panelFeatureState.decorView.isAttachedToWindow()) {
