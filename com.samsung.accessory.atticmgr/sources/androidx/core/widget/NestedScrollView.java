...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    private boolean seslDispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if ((motionEvent.getSource() & 2) != 0 && motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != 0.0f) {
                ...
                if (verticalScrollFactorCompat != scrollY) {
                    ...
                    if (!dispatchNestedPreScroll(0, verticalScrollFactorCompat, null, null, 1)) {
    ...
    private void ensureGlows() {
        if (getOverScrollMode() == 2) {
            ...
            this.mEdgeGlowTop.setHostView(this);
            this.mEdgeGlowBottom.setHostView(this);
        }
    }
