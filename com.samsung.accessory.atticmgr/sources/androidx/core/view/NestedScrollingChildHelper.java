...
public class NestedScrollingChildHelper {
    ...
    public boolean seslDispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        return dispatchNestedScrollInternal(i, i2, i3, i4, iArr, i5, iArr2);
    }
