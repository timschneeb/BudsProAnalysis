...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public FragmentTransaction setAnimations() {
        if (isDefaultTheme(this.mManager.mHost.getContext())) {
            this.mEnterAnim = R.anim.sesl_fragment_open_enter;
            this.mExitAnim = R.anim.sesl_fragment_open_exit;
            this.mPopEnterAnim = R.anim.sesl_fragment_close_enter;
            this.mPopExitAnim = R.anim.sesl_fragment_close_exit;
        }
        return this;
    }
