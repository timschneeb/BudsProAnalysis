...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    static final Interpolator sQuinticInterpolator = new Interpolator() {
        /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass8 */
    ...
    private boolean mGlowByDragging;
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAnimListener = new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                RecyclerView.this.mLastItemAddRemoveAnim = null;
                RecyclerView.this.mIsSetOnlyAddAnim = false;
                RecyclerView.this.mIsSetOnlyRemoveAnim = false;
        ...
        this.mHoverHandler = new Handler(Looper.getMainLooper()) {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:45:0x014d, code lost:
                if (r14.this$0.mChildBound.bottom <= (r14.this$0.getHeight() - r14.this$0.mListPadding.bottom)) goto L_0x0150;
             */
        ...
        this.mItemAnimatorRunner = new Runnable() {
            /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass7 */
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() {
            /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass9 */
        ...
        this.mRoundedCorner = new SeslSubheaderRoundedCorner(getContext());
    ...
    public void seslInitConfigurations(Context context) {
        ...
        this.mGoToTopElevation = resources.getDimensionPixelSize(R.dimen.sesl_go_to_top_elevation);
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass10 */
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() {
            /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass11 */
    ...
    public void setScrollState(int i) {
        ...
        if (i != this.mScrollState) {
            ...
            if (this.mIndexTipEnabled && (indexTip = this.mIndexTip) != null && i == 0) {
                indexTip.hide();
            }
        }
    }
    ...
    public void ensureLeftGlow() {
        if (this.mLeftGlow == null) {
            ...
            this.mLeftGlow.setHostView(this);
    ...
    public void ensureRightGlow() {
        if (this.mRightGlow == null) {
            ...
            this.mRightGlow.setHostView(this);
            if (this.mClipToPadding) {
    ...
    public void ensureTopGlow() {
        if (this.mTopGlow == null) {
            ...
            this.mTopGlow.setHostView(this);
            if (this.mClipToPadding) {
    ...
    public void ensureBottomGlow() {
        if (this.mBottomGlow == null) {
            ...
            this.mBottomGlow.setHostView(this);
            if (this.mClipToPadding) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (actionMasked == MOTION_EVENT_ACTION_PEN_DOWN && this.mIgnoreMotionEventTillDown) {
            this.mIgnoreMotionEventTillDown = false;
        }
        if (this.mScrollState == 1) {
            return true;
    ...
    private void dispatchLayoutStep3() {
        ...
        if (this.mDrawRect && !canScrollVertically(-1) && !canScrollVertically(1)) {
            ...
            if (i >= 0 && i <= findLastVisibleItemPosition() && (childAt = this.mChildHelper.getChildAt(i)) != null) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            if (this.mIndexTipEnabled && (indexTip = this.mIndexTip) != null) {
                indexTip.setLayout(0, 0, i3, i4, getPaddingLeft(), getPaddingRight());
            }
        }
    }
        ...
        if (!(!this.mIsPenDragBlockEnabled || this.mIsLongPressMultiSelection || this.mLayout == null)) {
            if (!(this.mPenDragBlockLeft == 0 && this.mPenDragBlockTop == 0)) {
                ...
                if (i3 >= findFirstVisibleItemPosition && i3 <= findLastVisibleItemPosition) {
                    this.mPenTrackedChild = this.mLayout.findViewByPosition(i3);
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (recyclerView4.seslDispatchNestedScroll(i2, i, i3, i4, null, 1, recyclerView4.mReusableIntPair)) {
        ...
        public void fling(int i, int i2) {
            ...
            SeslOverScrollerReflector.fling(this.mOverScroller, 0, 0, i, i2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, RecyclerView.this.mIsSkipMoveEvent, RecyclerView.this.mApproxLatency);
            SeslOverScrollerReflector.setSmoothScrollEnabled(RecyclerView.this.mViewFlinger.mOverScroller, true);
            postOnAnimation();
        }

        public void smoothScrollBy(int i, int i2, int i3, Interpolator interpolator) {
            int computeScrollDuration = i3 == Integer.MIN_VALUE ? computeScrollDuration(i, i2, 0, 0) : i3;
            ...
            if (!RecyclerView.this.dispatchNestedPreScroll(i, i2, null, null, 1)) {
                ...
                this.mLastFlingX = 0;
                RecyclerView.this.setScrollState(2);
                this.mOverScroller.startScroll(0, 0, i, i2, computeScrollDuration);
    ...
    private boolean seslDispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        return getScrollingChildHelper().seslDispatchNestedScroll(i, i2, i3, i4, iArr, i5, iArr2);
    }
    ...
    private void runLastItemAddDeleteAnim(View view) {
        if (this.mLastItemAddRemoveAnim == null) {
            ...
            if (this.mIsSetOnlyAddAnim) {
                this.mLastItemAddRemoveAnim = ValueAnimator.ofInt(this.mLastItemAnimTop, ((int) view.getY()) + view.getHeight());
            } else if (this.mIsSetOnlyRemoveAnim) {
                this.mLastItemAddRemoveAnim = ValueAnimator.ofInt(this.mLastItemAnimTop, view.getBottom());
            }
            ...
            this.mLastItemAddRemoveAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass12 */
        ...
        if (this.mDrawRect && (!(this.mBlackTop == -1 && this.mLastBlackTop == -1) && !canScrollVertically(-1) && (!canScrollVertically(1) || isAnimating()))) {
            ...
            if (!(i2 == -1 && this.mAnimatedBlackTop == i2 && !this.mIsSetOnlyAddAnim)) {
                ...
                if (this.mDrawLastRoundedCorner) {
                    this.mRoundedCorner.drawRoundedCorner(0, this.mAnimatedBlackTop, getRight(), getBottom(), canvas);
                }
            }
        }
    ...
    public void seslSetGoToTopEnabled(boolean z, boolean z2) {
        ...
        if (this.mGoToTopImage != null) {
            if (z) {
                if (this.mGoToTopView == null) {
                    ...
                    if (Build.VERSION.SDK_INT >= 26) {
                        ...
                        if (!isLightTheme || !z2) {
                            drawable = this.mContext.getResources().getDrawable(R.drawable.sesl_go_to_top_background_dark, null);
                        } else {
                            drawable = this.mContext.getResources().getDrawable(R.drawable.sesl_go_to_top_background_light, null);
                        }
            ...
            this.mGoToTopFadeInAnimator = ValueAnimator.ofFloat(0.0f, 1.0f);
            ...
            this.mGoToTopFadeInAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass14 */
            ...
            this.mGoToTopFadeOutAnimator = ValueAnimator.ofFloat(1.0f, 0.0f);
            ...
            this.mGoToTopFadeOutAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass15 */
            ...
            this.mGoToTopFadeOutAnimator.addListener(new Animator.AnimatorListener() {
                /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass16 */
    ...
    private void playGotoToFadeOut() {
        if (!this.mGoToTopFadeOutAnimator.isRunning()) {
            ...
            this.mGoToTopFadeOutAnimator.setFloatValues(this.mGoToTopView.getAlpha(), 0.0f);
    ...
    private void playGotoToFadeIn() {
        if (!this.mGoToTopFadeInAnimator.isRunning()) {
            ...
            this.mGoToTopFadeInAnimator.setFloatValues(this.mGoToTopView.getAlpha(), 1.0f);
        ...
        if (this.mEnableGoToTop) {
            if (i == 0) {
                if (!seslIsFastScrollerEnabled()) {
                    ...
                    postDelayed(this.mAutoHide, 2500);
                }
            } else if (i == 1) {
                removeCallbacks(this.mAutoHide);
                postDelayed(this.mAutoHide, 2500);
    ...
    private boolean isNavigationBarHide(Context context) {
        if (!isSupportSoftNavigationBar(context)) {
            return true;
        }
        if (Settings.Global.getInt(context.getContentResolver(), "navigationbar_hide_bar_enabled", 0) == 1) {
            return true;
        }
        return false;
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setupGoToTop(int i) {
        if (this.mEnableGoToTop) {
            removeCallbacks(this.mAutoHide);
            ...
            this.mGoToTopView.layout(this.mGoToTopRect.left, this.mGoToTopRect.top, this.mGoToTopRect.right, this.mGoToTopRect.bottom);
    ...
    private void drawGoToTop() {
        this.mGoToTopView.setTranslationY((float) getScrollY());
    ...
    public void seslSetImmersiveScrollBottomPadding(int i) {
        if (i >= 0) {
            if (this.mEnableGoToTop) {
                int height = ((getHeight() - this.mGoToTopSize) - this.mGoToTopBottomPadding) - i;
                if (height < 0) {
                    this.mGoToTopImmersiveBottomPadding = 0;
                    Log.e(TAG, "The Immersive padding value (" + i + ") was too large to draw GoToTop.");
                    return;
                }
                this.mGoToTopImmersiveBottomPadding = i;
                if (this.mGoToTopState != 0) {
                    int paddingLeft = getPaddingLeft() + (((getWidth() - getPaddingLeft()) - getPaddingRight()) / 2);
                    Rect rect = this.mGoToTopRect;
                    int i2 = this.mGoToTopSize;
                    rect.set(paddingLeft - (i2 / 2), height, paddingLeft + (i2 / 2), i2 + height);
                    this.mGoToTopView.layout(this.mGoToTopRect.left, this.mGoToTopRect.top, this.mGoToTopRect.right, this.mGoToTopRect.bottom);
                }
            }
            SeslRecyclerViewFastScroller seslRecyclerViewFastScroller = this.mFastScroller;
            if (seslRecyclerViewFastScroller != null && this.mAdapter != null) {
                seslRecyclerViewFastScroller.setImmersiveBottomPadding(i);
    ...
    public void seslSetIndexTipEnabled(boolean z) {
        if (this.mAdapter instanceof SectionIndexer) {
            if (z) {
                ...
                this.mIndexTip.setLayout(0, 0, getRight(), getBottom(), getPaddingLeft(), getPaddingRight());
    ...
    public void seslUpdateIndexTipPosition() {
        ...
        if (indexTip.mCurrentOrientation == 1) {
            this.mIndexTip.mIsNeedUpdate = true;
            this.mIndexTip.invalidate();
            return;
        }
        this.mIndexTip.mIsNeedUpdate = false;
    }
    ...
    public class IndexTip extends View {
        ...
        private static final float SHAPE_COLOR_ALPHA_RATIO = 0.8f;
        ...
        private IndexTip(Context context) {
            ...
            this.mTextDelayRunnable = new Runnable() {
                /* class androidx.recyclerview.widget.RecyclerView.IndexTip.AnonymousClass2 */

                public void run() {
                    if (RecyclerView.this.mIndexTip != null) {
                        IndexTip indexTip = IndexTip.this;
                        indexTip.mShowingText = indexTip.mTargetText;
                        IndexTip.this.invalidate();
                    }
                }
            };
            this.mShapeDelayRunnable = new Runnable() {
                /* class androidx.recyclerview.widget.RecyclerView.IndexTip.AnonymousClass3 */

                public void run() {
                    if (RecyclerView.this.mIndexTip != null && IndexTip.this.mIsShowing) {
                        IndexTip.this.startAnimation();
                        IndexTip.this.mIsShowing = false;
                    }
                }
            };
            init();
        ...
        private void init() {
            ...
            RecyclerView.this.mContext.getTheme().resolveAttribute(R.attr.colorPrimary, typedValue, true);
            int color = typedValue.resourceId != 0 ? ResourcesCompat.getColor(RecyclerView.this.mContext.getResources(), typedValue.resourceId, null) : typedValue.data;
            this.mShapePaint = new Paint();
            this.mShapePaint.setStyle(Paint.Style.FILL);
            this.mShapePaint.setAntiAlias(true);
            this.mShapePaint.setColor(getColorWithAlpha(color, SHAPE_COLOR_ALPHA_RATIO));
            this.mTextPaint = new Paint();
            this.mTextPaint.setAntiAlias(true);
            this.mTextPaint.setTypeface(Typeface.create(RecyclerView.this.mContext.getString(androidx.appcompat.R.string.sesl_font_family_regular), 0));
            ...
            this.mHeight = resources.getDimensionPixelSize(R.dimen.sesl_index_tip_height);
            this.mSidePadding = resources.getDimensionPixelSize(R.dimen.sesl_index_tip_padding);
            ...
            this.mCenterY = this.mTopMargin + Math.round(((float) this.mHeight) / 2.0f);
            this.mParentPosY = 0;
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void setLayout(int i, int i2, int i3, int i4, int i5, int i6) {
            layout(i, i2, i3, i4);
            this.mCenterX = i5 + Math.round(((float) (((i3 - i) - i5) - i6)) / 2.0f);
            this.mCurrentOrientation = RecyclerView.this.mContext.getResources().getConfiguration().orientation;
        ...
        private void subString(String str) {
            ...
            } while ((this.mTextPaint.measureText(str) / 2.0f) + ((float) this.mSidePadding) >= ((float) this.mMaxWidth));
            this.mText = str;
        }
        ...
        private void animating(float f) {
            ValueAnimator valueAnimator = this.mValueAnimator;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.mValueAnimator = ValueAnimator.ofFloat(this.mAnimatingWidth, f);
            this.mValueAnimator.setDuration(200L);
            this.mValueAnimator.setInterpolator(this.SCALE_INTERPOLATOR);
            this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class androidx.recyclerview.widget.RecyclerView.IndexTip.AnonymousClass1 */

                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    IndexTip.this.mAnimatingWidth = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                    IndexTip.this.invalidate();
                }
            });
        ...
        private void show(int i, int i2) {
            if (i == 1 && RecyclerView.this.mRemainNestedScrollRange != 0 && i2 >= 0) {
                RecyclerView.this.adjustNestedScrollRange();
            } else if (i2 != 0 && !this.mIsShowing && RecyclerView.this.canScrollUp() && !RecyclerView.this.mGoToToping && !this.mForcedHide) {
                startAnimation();
        ...
        private void startAnimation() {
            ...
            if (this.mIsShowing) {
                objectAnimator = ObjectAnimator.ofFloat(RecyclerView.this.mIndexTip, "alpha", RecyclerView.this.mIndexTip.getAlpha(), 0.0f);
            } else {
                objectAnimator = ObjectAnimator.ofFloat(RecyclerView.this.mIndexTip, "alpha", RecyclerView.this.mIndexTip.getAlpha(), 1.0f);
            }
    ...
    private void updateLongPressMultiSelection(int i, int i2, boolean z) {
        ...
        if (childLayoutPosition != -1) {
            ...
            int i8 = this.mPenTrackedChildPosition;
            int i9 = this.mPenDragSelectedViewPosition;
            if (i8 < i9) {
                i6 = i8;
                i5 = i9;
            } else {
            ...
            int i10 = this.mPenDragStartX;
            int i11 = this.mPenDragEndX;
            if (i10 >= i11) {
                i10 = i11;
            }
            this.mPenDragBlockLeft = i10;
            ...
            while (true) {
                ...
                if (childAt != null) {
                    ...
                    if (childAt.getVisibility() == 0) {
                        ...
                        if (i6 > i19 || i19 > i5 || i19 == this.mPenTrackedChildPosition) {
                            z2 = false;
                        }
                        if (z2) {
                            int i20 = this.mPenDragSelectedViewPosition;
                            if (i20 != -1 && !this.mPenDragSelectedItemArray.contains(Integer.valueOf(i20))) {
            ...
            int i22 = this.mLastTouchY - i2;
            if (z && Math.abs(i22) >= this.mTouchSlop) {
                if (i2 <= i3 + this.mHoverTopAreaHeight && i22 > 0) {
                ...
                } else if (i2 < (i4 - this.mHoverBottomAreaHeight) - this.mRemainNestedScrollRange || i22 >= 0) {
    ...
    public View seslFindNearChildViewUnder(float f, float f2) {
        ...
        while (childCount >= 0) {
            ...
            if (childAt2 != null) {
                ...
                if (i4 > bottom || childCount == 0) {
                    if (i3 < i10) {
                        return this.mChildHelper.getChildAt(i8);
                    }
    ...
    private boolean isInDialog() {
        ...
        return !(context instanceof Activity) || ((Activity) context).getWindow().getAttributes().type != 1;
    }
    ...
    private boolean pageScroll(int i) {
        ...
        this.mLayout.mRecyclerView.post(new Runnable() {
            /* class androidx.recyclerview.widget.RecyclerView.AnonymousClass17 */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:292:0x0426, code lost:
        if (r5 > (r3 ? getBottom() : getRight())) goto L_0x0428;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:297:0x0434, code lost:
        if (r17.mHoverScrollStartTime != 0) goto L_0x0439;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public void seslSetSmoothScrollEnabled(boolean z) {
        ...
        if (viewFlinger != null) {
            SeslOverScrollerReflector.setSmoothScrollEnabled(viewFlinger.mOverScroller, z);
        }
    }
