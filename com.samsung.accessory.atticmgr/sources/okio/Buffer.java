...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    private static final byte[] DIGITS = {48, MsgID.LOG_COREDUMP_DATA_SIZE, MsgID.LOG_COREDUMP_DATA, MsgID.LOG_COREDUMP_COMPLETE, MsgID.LOG_TRACE_START, MsgID.LOG_TRACE_DATA, MsgID.LOG_TRACE_COMPLETE, MsgID.LOG_TRACE_ROLE_SWITCH, MsgID.LOG_COREDUMP_DATA_DONE, MsgID.LOG_TRACE_DATA_DONE, MsgID.EXTENDED_STATUS_UPDATED, 98, MsgID.VERSION_INFO, 100, 101, 102};
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        writeByte((charAt >> 6) | XDMWbxml.WBXML_EXT_0);
                        ...
                        if (charAt > 56319 || c < 56320 || c > 57343) {
                            ...
                            writeByte((i7 >> 18) | XFOTAInterface.XDL_STATE_USER_CANCEL_REPORTING);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 6) | XDMWbxml.WBXML_EXT_0);
            writeByte((i & 63) | 128);
        } else if (i < 65536) {
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | 224);
            ...
            writeByte((i >> 18) | XFOTAInterface.XDL_STATE_USER_CANCEL_REPORTING);
